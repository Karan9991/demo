    ...
    public void parseJSON(){
        ...
        try{
            ...
            if(data != null) {
                ...
                Marker marker = MapsActivity2.mMap.addMarker(new MarkerOptions().position(latlong).title("Remote Location")
                        .snippet(remote_location));

                MapsActivity2.mMap.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
                ...
                MapsActivity2.mMap.moveCamera(CameraUpdateFactory.newLatLng(latlong));
